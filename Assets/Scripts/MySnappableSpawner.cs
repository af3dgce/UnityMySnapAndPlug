...
namespace SnapAndPlug
{
	 ...
	 */
    public class MySnappableSpawner : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            if (killDist > 0) InvokeRepeating("CheckSelfDestruct", 10f, 10f);
        ...
        void OnMouseDown()
        {
            ...
            gameObject.GetComponent<MySnappableSpawner>().SpawnGhostToMouse();
        ...
        public void SpawnGhostToMouse()
        {
            ...
            if (_currentPiece == null)
            {
                ...
                //_currentDistanceToPositionAt = 0f;
                //_currentPiece = GameObject.Instantiate( prefabSnapPiece ).GetComponent<SnapPiece>();
                _currentPiece = gameObject.GetComponent<SnapPiece>();
...
#pragma warning restore 219
        ...
        void OnMouseDrag()
        {
            ...
            Vector3 curScreenPoint = new Vector3(Input.mousePosition.x, Input.mousePosition.y, screenPoint.z);
            Vector3 mWorld = Camera.main.ScreenToWorldPoint(curScreenPoint) + offset;
